...
function Decorations() {
  return (
    <div id="bloc-02" class="section">
        ...
        <nav id="fil_ariane"><strong>Vous êtes ici :</strong> <a href="/">Accueil</a> &gt; <a href="#">Prestations</a> &gt;<a href="/">Décoration et aménagement d’intérieur</a> </nav>
    ...
    <div class="textetimage">
        <div class="flex-row m-align-items-stretch">
            <div>
                <h2 style={{fontFamily:' Satisfy', fontSize:'50px'}}>Nos architectes d’intérieur à Nanterre aménagent vos espaces</h2>
...
<p>Et pour vous aider à mieux vous projeter, nous concevons un plan 3D détaillé. Par ailleurs, vous pouvez contacter notre cabinet pour bénéficier d’un des services de nos architectes d'intérieur en visite avant l’achat du bien immobilier à Nanterre. Faites appel à nos <strong>architectes d’intérieur</strong> pour moderniser votre maison à <strong>Rueil-Malmaison, Suresnes</strong> et leurs environs.</p>            
</div>
            <div class="col-imgs12 m6" >
                <div class="image-wrapper m-fit-content">
                    <img src="https://www.inspyraya.com/photos/579x387/03.jpg" width="960" height="640" alt="déco salon" class="responsive-img" style={{width:'600px', height:'400px'}}/>
                </div>
            </div>
        </div>
    </div>
