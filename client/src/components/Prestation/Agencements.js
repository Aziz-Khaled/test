...
function Agencements() {
  return (
    ...
    <div id="bloc-02" class="section">
        ...
        <nav id="fil_ariane"><strong>Vous êtes ici :</strong> <a href="/">Accueil</a> &gt; <a href="#">Prestations</a> &gt; Agencement de locaux professionnels</nav>
    ...
    <div class="textetimage">
        <div class="flex-row m-align-items-stretch">
            <div>
            <h1 style={{fontFamily:' Satisfy', fontSize:'50px'}}>Agencement de locaux professionnelssur Sousse, Tunis ...</h1>
            <br/>
